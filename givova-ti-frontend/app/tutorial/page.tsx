...
export default function Tutorial() {
  ...
  return <main className="mx-auto max-w-5xl px-5 py-10 sm:px-6 sm:py-14">
    ...
    <section className="mt-8 overflow-hidden rounded-2xl border border-slate-200 bg-slate-950 shadow-lg">
      {embed ? <div className="aspect-video"><iframe className="size-full" src={embed} title="Tutorial: como abrir um chamado" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen /></div> : <div className="flex min-h-72 flex-col items-center justify-center px-6 text-center text-white"><PlayCircle className="size-12 text-orange-500" /><h2 className="mt-4 text-xl font-bold">Tutorial em vídeo em breve</h2><p className="mt-2 max-w-md text-sm leading-6 text-slate-300">Enquanto isso, siga os passos abaixo. Abrir um chamado leva menos de dois minutos.</p></div>}
    </section>
